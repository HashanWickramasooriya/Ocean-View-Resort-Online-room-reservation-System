...
<style>
:root{
  /* ✅ Ocean Breeze + Coral palette */
  --bg:#E0F2FE;             /* Primary Background */
  --card:#FFFFFF;           /* Secondary Background (Cards) */
  --primary:#0284C7;        /* Primary Accent */
...
body{
  ...
  background:
    ...
    radial-gradient(850px 650px at 35% 45%, rgba(251,113,133,0.12), transparent 62%),
...
.logo{
  ...
  background: linear-gradient(135deg, var(--primary), #22c1f0);
...
.logout:hover{ background: rgba(251,113,133,0.26); }
